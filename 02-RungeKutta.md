...
Continuando con el ejemplo guía de [PVI](01-PVI.md) ($y' = -2y$, $y(0) = 1$, $h = 0.1$, solución exacta $y = e^{-2x}$), un paso desde $x_0 = 0$:
...
![Error global en función del valor de h cuando los métodos de Euler, RK2 y RK4 integran la ecuación de prueba $y' = -2 y$. El gráfico está en escala log-log y las curvas punteadas tienen las pendientes h, h² y h⁴](figs/rk_convergencia.png)
